...
export default function IdeanatorPage() {
  ...
  function runRigPreview() {
    ...
    setOutput(
      "The Rig is assembled. Next step is wiring this button to a second backend route that sends the editable blueprint plus the fog to Claude and returns the actual finished output."
    );
  }
