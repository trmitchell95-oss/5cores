 ...
 * {
 ...
 {latestReport.title || "Untitled Idea"}
 </div>
 ...
 <p className="muted">
 No saved idea reports yet. Drop one in and let the raw idea make noise.
 </p>
 )}
 </div>
 </section>
 ...
 <a
 className="small-link"
 href={`/ideanator?ideaReport=${encodeURIComponent(report.id)}`}
 >
 Build Rig
 </a>
