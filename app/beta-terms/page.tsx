...
export default function BetaTermsPage() {
  ...
  const thirdLabel = isIdeanator ? "Idea Reports" : "Sphinx";
    ...
    <main className={isIdeanator ? "terms-shell idea-terms" : "terms-shell"}>
      ...
      <div className="wrap">
        ...
        <section className="section-card">
          ...
          <p className="body-text">
            {isIdeanator
              ? "The Ideanator is being built around account separation, saved idea report history, user-controlled deletion, usage limits, and clear beta expectations before payment is added."
