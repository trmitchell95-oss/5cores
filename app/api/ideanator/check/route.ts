...
Use NOT READY YET when it is too vague, contradictory, risky, empty, or likely to produce bad output.
...
export async function POST(request: NextRequest) {
 ...
 ? error.message
 : "The rig check could not run. Please try again.",
 },
 { status: 500 }
 );
 }
