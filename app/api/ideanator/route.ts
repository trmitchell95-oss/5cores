...
function buildMockReport({
 ...
 "Build the smallest ugly version possible before adding any fancy confusion.",
 ],
 };
}
...
export async function GET() {
 ...
 ok: true,
 message:
 "The Ideanator API route is alive. POST an idea here when you are ready to put the raw idea on the lift.",
...
export async function POST(request: NextRequest) {
 ...
 {
 ok: false,
 error: "The Ideanator could not start the idea check. Please try again.",
 },
 { status: 500 },
 );
 }
