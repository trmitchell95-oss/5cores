...
function toolLabel(tool: string) {
  ...
  if (tool === "ideanator_check") return "Idea Check";
  if (tool === "ideanator_blueprint") return "Rig Blueprint";
  if (tool === "ideanator_run") return "Rig Run";
  if (tool === "ideanator") return "Legacy Ideanator";
  return tool;
}
      ...
      <div className="wrap">
        ...
        {summary && (
          <section className="summary-grid">
            ...
            <div className="card">
              <div className="card-label">Rig Workbench</div>
